...
const Knowledge = dynamic(
  () => import('~/components/sections/resume/Knowledge')
)

const Technologies = dynamic(
  () => import('~/components/sections/resume/Technologies')
)

const WorkExperience = dynamic(
  () => import('~/components/sections/resume/WorkExperience')
)

const Education = dynamic(
  () => import('~/components/sections/resume/Education')
)

const CertificatesHobbies = dynamic(
  () => import('~/components/sections/resume/CertificatesHobbies')
)

const CareerTimeline = dynamic(
  () => import('~/components/sections/resume/CareerTimeline')
)
